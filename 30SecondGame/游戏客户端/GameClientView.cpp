...
//按钮标识
#define IDC_CM_BUTTON_1000			200									//按钮标识
#define IDC_CM_BUTTON_10000			201									//按钮标识
#define IDC_CM_BUTTON_50000			202									//按钮标识
#define IDC_CM_BUTTON_100000		203									//按钮标识
#define IDC_CM_BUTTON_500000        301                                 //50万筹码(陈工)
...
#define IDC_VIEW_CARD				212									//按钮标识
#define IDC_BANK_STORAGE			213									//按钮标识
#define IDC_BANK_DRAW				215									//按钮标识
...
#define DEAL_MOVE_COUNT_H			10									//发牌最大步数
...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(m_pClientControlDlg)
	{
		...
		m_SkinListCtrl[AREA_XIAN].InsertColumn(0,TEXT("闲"));
		m_SkinListCtrl[AREA_PING].InsertColumn(0,TEXT("平"));
		m_SkinListCtrl[AREA_ZHUANG].InsertColumn(0,TEXT("庄"));
		m_SkinListCtrl[AREA_XIAN_TIAN].InsertColumn(0,TEXT("闲天王"));
		m_SkinListCtrl[AREA_ZHUANG_TIAN].InsertColumn(0,TEXT("庄天王"));
		m_SkinListCtrl[AREA_TONG_DUI].InsertColumn(0,TEXT("同点平"));
		m_SkinListCtrl[AREA_XIAN_DUI].InsertColumn(0,TEXT("闲对子"));
		m_SkinListCtrl[AREA_ZHUANG_DUI].InsertColumn(0,TEXT("庄对子"));
	}
...
void CGameClientView::DrawTopInfo(CDC *pDC, int nWidth, int nHeight)
{
	...
	CDFontEx::DrawText(this,pDC,12, 400, TEXT("庄家:"), rcBanker, RGB(184,208,208),  DT_END_ELLIPSIS|DT_LEFT|DT_VCENTER|DT_SINGLELINE);
    ...
    CDFontEx::DrawText(this,pDC,12, 400, TEXT("分数:"), rcBanker, RGB(184,208,208),  DT_END_ELLIPSIS|DT_LEFT|DT_VCENTER|DT_SINGLELINE);
	rcBanker.OffsetRect(33, 0);
	...
	// 庄家成绩
	rcBanker.OffsetRect(-33, 22);
    CDFontEx::DrawText(this,pDC,12, 400, TEXT("成绩:"), rcBanker, RGB(184,208,208),  DT_END_ELLIPSIS|DT_LEFT|DT_VCENTER|DT_SINGLELINE);
	rcBanker.OffsetRect(33, 0);
	...
	// 庄家局数
	rcBanker.OffsetRect(-33, 22);
    CDFontEx::DrawText(this,pDC,12, 400, TEXT("局数:"), rcBanker, RGB(184,208,208),  DT_END_ELLIPSIS|DT_LEFT|DT_VCENTER|DT_SINGLELINE);
	rcBanker.OffsetRect(33, 0);
	...
	CDFontEx::DrawText(this,pDC,12, 400, TEXT("  昵称"), rcBanker, RGB(184,208,208),  DT_END_ELLIPSIS|DT_LEFT|DT_VCENTER|DT_SINGLELINE);
...
void CGameClientView::OnTimer(UINT nIDEvent)
{
	...
	else if ( nIDEvent == IDI_FLEX_MOVE )		//伸缩框架
	{
...
void CGameClientView::FinishDispatchCard(bool bScene)
{
	...
	swprintf(szBuffer,CountArray(szBuffer),TEXT("本方：%I64d"),m_lPlayAllScore);
	m_pGameClientDlg->m_pIStringMessage->InsertCustomString(szBuffer,RGB(255,255,255));

	swprintf(szBuffer,CountArray(szBuffer),TEXT("庄家：%I64d"),m_LBankerWinScoreCurrent);
	m_pGameClientDlg->m_pIStringMessage->InsertCustomString(szBuffer,RGB(255,255,255));
...
void CGameClientView::ControlBetDetection( BYTE cbViewIndex, LONGLONG lScoreCount, WORD wChair )
{
	...
	if ( nItem == -1 )
	{
		nItem = m_SkinListCtrl[cbViewIndex].InsertItem(m_SkinListCtrl[cbViewIndex].GetItemCount(), pUserData->GetNickName());//插入行
	}


	CString strScore;
	strScore.Format(TEXT("%I64d"), m_lAllPlayBet[wChair][cbViewIndex]);
	m_SkinListCtrl[cbViewIndex].SetItemText(nItem, 1, strScore);		//设置数据
}