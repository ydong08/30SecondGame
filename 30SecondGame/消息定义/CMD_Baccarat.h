...
#define GAME_NAME					TEXT("港澳30秒")						//游戏名字
...
#define SUB_S_JETTON_DETAIL         110                                 //下注列表
#define SUB_S_ADMIN_STORAGE         211                                 //库存通知
...
struct CMD_S_GameStart
{
	...
	BYTE                            bRealUser[GAME_PLAYER];              //机器人 
};
...
#define SUB_C_ADMIN_RESET_STORAGE   8                                  //清除库存
...
struct tagJettonUser
{
	//玩家信息
	WORD                            wChairID;
	TCHAR                           strUserName[32];                                              //玩家帐号
	LONGLONG                        lUserJettonScore[AREA_MAX+1];                             //玩家金币
};
